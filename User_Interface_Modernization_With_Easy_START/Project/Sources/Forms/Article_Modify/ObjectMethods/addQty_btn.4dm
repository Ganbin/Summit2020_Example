...
Case of 
	: ($evt=On Load:K2:1)
		...
		Form:C1466[$btn_name].PicturePath(AJUI_btn_default;"Images/icons/plus.svg")
		Form:C1466[$btn_name].PictureScale(AJUI_btn_default;65)
		  //Form[$btn_name].BGColor(AJUI_btn_default;"black:0")
		...
		Form:C1466[$btn_name].OnClick("PS_addQty_cb")
End case 
