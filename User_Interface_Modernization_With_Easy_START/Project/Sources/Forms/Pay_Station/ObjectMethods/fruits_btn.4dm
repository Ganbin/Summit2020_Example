...
Case of 
	: ($evt=On Load:K2:1)
		...
		Form:C1466[$btn_name].Label(AJUI_btn_default;Get localized string:C991("main.groups.fruits"))
		Form:C1466[$btn_name].Composition("composite")
		Form:C1466[$btn_name].PicturePath(AJUI_btn_default;"Images/icons/fruits.png")
