...
Case of 
	: ($evt=On Load:K2:1)
		...
		Form:C1466[$btn_name].Label(AJUI_btn_default;Get localized string:C991("main.groups.vegetables"))
		Form:C1466[$btn_name].Composition("composite")
		Form:C1466[$btn_name].PicturePath(AJUI_btn_default;"Images/icons/vegetables.png")
		...
		Form:C1466[$btn_name].PictureScale(AJUI_btn_default;70)
		  //Form[$btn_name].PictureHeight(AJUI_btn_default;100)
		  //Form[$btn_name].PictureWidth(AJUI_btn_default;160)
		  //Form[$btn_name].CompPadding(AJUI_btn_default;0)
